...
<main>
	...
	<section class="bg-gray-100 py-32">
		<div class="container mx-auto px-4 flex justify-center">
			<div class="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-4xl">
				<div
					class="flex flex-col bg-white shadow-md rounded-lg py-4 px-6 text-center justify-between"
				>
					<span class="text-blue-400 text-3xl text-center font-semibold uppercase mb-1"
						>Connect</span
					>
					<span class="mb-3 text-charcoal">Sync your compatible <br /> synthesizer instrument</span>
					<div class="flex justify-center">
						<a
							class="border border-midiBlue rounded-lg text-center text-midiBlue py-1 px-10 uppercase"
							href="#">Link</a
						>
					</div>
				</div>
	...
	<div class="py-32 text-center">
		<a href="https://sepolia.sonobay.xyz" class="uppercase bg-gold text-2xl py-3 px-6 rounded-xl"
			>Enter Market</a
		>
	</div>
	...
	<footer class="bg-gray-50">
		<div
			class="container mx-auto px-4 py-12 flex justify-between items-center md:items-end flex-col md:flex-row"
		>
			<div class="flex flex-col order-last md:order-first mt-8 md:mt-0 items-center md:items-start">
				...
				<div class="flex mb-2">
					<a href="#" class="w-6 flex items-align mr-2">
						<svg fill="#696969" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"
					...
					<a href="#" class="w-6 flex items-align mr-2">
						<svg fill="#696969" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
							><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path
					...
					<a href="#" class="w-6 flex items-align mr-2">
						<svg fill="#696969" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
							><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path
					...
					<a href="#" class="w-6 flex items-align mr-2">
						<svg fill="#696969" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"
							><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path
