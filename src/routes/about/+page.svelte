<section
	class="flex flex-col items-center justify-center text-center relative py-24 px-4 overflow-x-hidden"
	aria-label="about Sono Bay"
>
	<div class="relative container">
		...
		>
			...
			<div
				class="w-full lg:w-1/3 flex-col sm:flex-row lg:flex-col flex items-center text-center gap-12 lg:gap-16 mt-16 lg:mt-0"
			>
				<div>
		...
		<div
			class="container absolute w-[800px] h-[800px] rounded-full bg-white -right-[600px] top-0"
		/>
	</div>
</section>
